<template>
  <div class="order">
      ...
      <div class="order-card-wrap" v-if="order.shopInfoName" @click="$router.push({name:'orderInfo',params:{order}})">
...
export default{
 ...
 beforeRouteEnter(to, from, next) {
  ...
  methods: {
    getData() {
      this.$axios(`/apis/api/user/orders/${localStorage.ele_login}`).then(res => {
